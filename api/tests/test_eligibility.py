...
def test_vaccinations_conform_to_vaccination_policy(caplog):
    ...
    with caplog.at_level(logging.DEBUG, logger="signing"):
        ...
        assert statement_matches_to_vaccination_policy(StatementOfVaccination(**vaccination_events)) is True
    ...
    with caplog.at_level(logging.DEBUG, logger="signing"):
        ...
        assert statement_matches_to_vaccination_policy(StatementOfVaccination(**vaccination_events)) is False
